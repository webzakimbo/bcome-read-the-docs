...
By default, 'sh' assumes a "/bin/sh" shell present on your container. In console mode (see :doc:`../usage/navigation`) you may pick an alternative shell by reference when invoking `sh`.
