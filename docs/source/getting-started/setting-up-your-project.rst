...
.. hint::
   ...
   Make sure you've read the installation requirements: :doc:`../getting-started/setting-up-your-project`, and if you're new to Ruby, then consider using |RVM_URL|_ to manage it.
