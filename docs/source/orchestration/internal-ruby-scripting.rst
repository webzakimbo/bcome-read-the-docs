...
Internal scripts are always invoked in the context of a node and can be configured to accept arguments (for integration, see :doc:`../registry/overview`).
...
The node context in which the internal script was called is available to you in the form of an instance variable named :doc:`../core-concepts/node`.
...
Note that the parent (i.e. :doc:`../core-concepts/estate`) root node key is implicit.
